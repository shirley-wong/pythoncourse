...
def exercise03():
    ...
    sentence = 'I live in New York City.'
...
def exercise04():
    ...
    first_name, last_name = ('Sin Ying', 'Wong')
...
def exercise06():
    ...
    hours_worked, wage_per_hour = (20, 15)
